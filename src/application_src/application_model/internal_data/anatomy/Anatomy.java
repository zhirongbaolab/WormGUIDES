...
package application_src.application_model.internal_data.anatomy;
...
public class Anatomy {
    ...
    public static void initAnatomy() {
        final URL url = MainApp.class.getResource("/application_src/application_model/internal_data/anatomy/anatomy.csv");
