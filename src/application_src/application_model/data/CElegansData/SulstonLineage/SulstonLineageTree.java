 ...
 */
public class SulstonLineageTree extends GenericLineageTree {
    ...
    public SulstonLineageTree(final String[] allCellNames, final boolean isSulstonMode) {
        ...
        SulstonLineageTree.isSulstonMode = isSulstonMode;
        if (isSulstonMode) {
